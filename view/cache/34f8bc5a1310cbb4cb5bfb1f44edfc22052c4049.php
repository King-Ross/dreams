                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-xl-4">
                            <div class="text-center">
                                <img id="profile-photo" src="/<?php echo e($appName); ?>/assets/img/avatar.png"  alt="Profile" width="300px" height="300px" style="border: 3px solid #999; object-fit: cover;">
                            ...
                            <div class="">
                                <div class="card-body pt-3">
                                    ...
                                    <div class="text-left pt-3">
                                        <button id="save-profile-button" type="submit" class="btn btn-primary btn-sm">Add Employee</button>
