            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        require_once('../LaundaryManagementSystem/vendor/pesapal/pesapal/OAuth.php');
                        require_once('../LaundaryManagementSystem/vendor/pesapal/db/dbconnector.php');
                        require_once('../LaundaryManagementSystem/vendor/pesapal/pesapal/checkStatus.php');
                        ...
                        <div class="m-4">
                            <h3>Thankyou for paying your bill, transaction is complete</h3>
