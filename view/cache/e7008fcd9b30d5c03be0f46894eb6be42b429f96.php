        ...
        <div class="card">
          <div class="d-flex  align-items-center  px-3">
            <div class="pagetitle p-2 order-0 w-50">
              <h1 class="py-1">Bill Payments</h1>
          ...
          <div class="card-body">
            ...
            $callback_url   = 'http://localhost/LaundaryManagementSystem/dashboard/orders/bills/pay/thankyou/'; //URL user to be redirected to after payment
