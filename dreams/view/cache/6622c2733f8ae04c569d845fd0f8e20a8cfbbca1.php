...
<main id="main" class="main">
    ...
    <section class="section dashboard">
        <div class="row">
            ...
            <div class="p-2">
                <button class="btn btn-sm btn-primary mb-3" id="export-pdf-btn">Export Complete Orders PDF</button>
                <div class="card-body">
...
<script>
    $(document).ready(function() {
        $("#export-pdf-btn").on("click", function() {
            ...
            $.ajax({
                url: '/<?php echo e($appName); ?>/dashboard/reports/orders/complete/print/',
                method: 'POST',
                processData: false,
                contentType: false,
