...
<main id="main" class="main">
  <div class="d-flex align-items-center px-3">
    <div class="pagetitle p-2 order-0 w-50">
      <h1 class="py-1 text-dark">Your Profile Information</h1>
      <nav>
    ...
    <div class="row g-2">
      <div class="col-xl-4">
        <div class="text-center">
          <img src="<?php echo e($avator); ?>" alt="Profile"  alt="Profile" width="300px" height="300px" style="border: 3px solid #999; object-fit: cover;">
                ...
                <form id="edit-profile-form" class="needs-validation" novalidate>
                  ...
                  <div class="col-xl-12">
                    ...
                    <div class="">
                      <div class=" pt-3">
                        <div class="row mb-3">
                          <label for="fullName" class="col-md-4 col-lg-3 col-form-label text-dark">Full Name</label>
                        ...
                        <div class="row mb-3">
                          <label for="about" class="col-md-4 col-lg-3 col-form-label text-dark">About (Optional)</label>
                          <div class="col-md-8 col-lg-9">
                        ...
                        <div class="row mb-3">
                          <label for="company" class="col-md-4 col-lg-3 col-form-label text-dark">Company (Optional)</label>
                          <div class="col-md-8 col-lg-9">
                        ...
                        <div class="row mb-3">
                          <label for="Job" class="col-md-4 col-lg-3 col-form-label text-dark">Job Title</label>
                          <div class="col-md-8 col-lg-9">
                        ...
                        <div class="row mb-3">
                          <label for="nin" class="col-md-4 col-lg-3 col-form-label text-dark">NIN Number</label>
                          <div class="col-md-8 col-lg-9">
                        ...
                        <div class="row mb-3">
                          <label for="gender" class="col-md-4 col-lg-3 col-form-label text-dark">Gender</label>
                          <div class="col-md-8 col-lg-9">
                        ...
                        <div class="row mb-3">
                          <label for="dob" class="col-md-4 col-lg-3 col-form-label text-dark">Date of Birth</label>
                          <div class="col-md-8 col-lg-9">
                        ...
                        <div class="row mb-3">
                          <label for="Country" class="col-md-4 col-lg-3 col-form-label text-dark">Country</label>
                          <div class="col-md-8 col-lg-9">
                        ...
                        <div class="row mb-3">
                          <label for="Home District" class="col-md-4 col-lg-3 col-form-label text-dark">Home District</label>
                          <div class="col-md-8 col-lg-9">
                        ...
                        <div class="row mb-3">
                          <label for="village" class="col-md-4 col-lg-3 col-form-label text-dark">Village</label>
                          <div class="col-md-8 col-lg-9">
                        ...
                        <div class="row mb-3">
                          <label for="Phone" class="col-md-4 col-lg-3 col-form-label text-dark">Phone</label>
                          <div class="col-md-8 col-lg-9">
