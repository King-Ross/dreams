...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3435180710ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=cdc_dreams_db&table=user_profile">`cdc_dreams_db`.`user_profile`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=cdc_dreams_db&table=app_users">`cdc_dreams_db`.`app_users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pharmacy&table=admin_credentials">`pharmacy`.`admin_credentials`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pharmacy&table=customers">`pharmacy`.`customers`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ovs&table=candidate">`ovs`.`candidate`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ovs&table=users">`ovs`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=onlinevotingsystem&table=users">`onlinevotingsystem`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ovs&table=votes">`ovs`.`votes`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ovs&table=voters">`ovs`.`voters`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tech_forum&table=user">`tech_forum`.`user`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="35795c732c74246f6c416f615d776b5e">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="pharmacy" targettable="admin_credentials">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `admin_credentials`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="pharmacy" targettable="admin_credentials">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `admin_credentials`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="pharmacy" targettable="customers">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">DROP DATABASE pharmacy;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="pharmacy" targettable="">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">/*!40101 SET COLLATION_CONNECTION=@OLD_COLLATION_CONNECTION */;</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="cdc_dreams_db" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">/*!40101 SET COLLATION_CONNECTION=@OLD_COLLATION_CONNECTION */;</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="cdc_dreams_db" targettable="app_users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `app_users`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="cdc_dreams_db" targettable="user_profile">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user_profile`</span>
                        </div>
